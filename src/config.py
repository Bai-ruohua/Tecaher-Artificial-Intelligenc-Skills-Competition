...
class Config:
    ...
    # 文件上传
    UPLOAD_DIR = os.path.join(DATA_DIR, "uploads")       # 原始文件存储根目录
    MAX_UPLOAD_SIZE = 100 * 1024 * 1024                   # 单文件最大 100MB
